...
//боковое меню, если один эелемент находится внутри другого, то нужно дописать как тут $('.cart__close').on('click', function(e){e.stopPropagation();$('.cart').removeClass('cart--active');});


  $('.user-nav__list--cart').on('click', function(){
